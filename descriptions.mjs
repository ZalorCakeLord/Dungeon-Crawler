export const descriptions = [
    ...
    },
    {
        ...
        contents: [
            { name: 'broken pews', description: 'The pews, once places of reverence, are now splintered and scattered, their wood rotting and falling apart.' },
            { name: 'shattered stained glass', description: 'Shattered pieces of stained glass litter the floor, and moonlight streaming through the broken windows casts fragmented colors across the dusty stone.' }
        ]
    },
    {
